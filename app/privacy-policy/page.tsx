      ...
      <div className="mt-8 space-y-6 rounded-3xl border border-border bg-white p-8 shadow-soft">
        ...
        <div>
          ...
          <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
            ...
            riferimenti del condominio, descrizione della richiesta, consenso privacy, esito dell'invio email e
            metadati tecnici minimi necessari alla sicurezza del modulo, inclusa la verifica anti-spam.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="mt-2 grid gap-2 text-sm leading-relaxed text-muted-foreground">
            ...
            <li>- Inviare conferme automatiche e notifiche operative tramite Resend.</li>
            <li>- Salvare copia della richiesta in un archivio tecnico privato su Vercel Blob.</li>
            <li>- Proteggere i moduli da invii automatici o abusivi tramite honeypot e challenge anti-spam.</li>
        ...
        <div>
          ...
          <ul className="mt-2 grid gap-2 text-sm leading-relaxed text-muted-foreground">
            ...
            <li>- Legittimo interesse alla prevenzione di spam, abusi e malfunzionamenti dei moduli.</li>
          </ul>
        </div>
        ...
        <div>
          ...
          <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
            ...
            tramite sito vengono salvate come file JSON privati su Vercel Blob e conservate per il tempo necessario
            a gestire il contatto, fornire assistenza, inviare eventuali risposte via email e adempiere agli obblighi
            previsti dalla normativa applicabile. Le email operative possono essere conservate anche nella casella
            di posta del titolare e nei sistemi Resend secondo le rispettive policy tecniche.
        ...
        <div>
          ...
          <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
            ...
            hosting e deploy su Vercel, salvataggio delle richieste su Vercel Blob, invio email tramite Resend,
            recapito delle notifiche alla casella email indicata dal titolare e misurazione statistica tramite
            Google Analytics 4 quando autorizzata.
        ...
        <div>
          ...
          <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
            ...
            analytics/marketing, inclusi Google Analytics 4 e l'eventuale Meta Pixel solo se configurato, consulta la{" "}
